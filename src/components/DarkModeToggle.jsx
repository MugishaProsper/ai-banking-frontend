...
export default function DarkModeToggle() {
  ...
  const toggleDarkMode = () => {
    ...
    console.log('Toggling theme from', isDark, 'to', newMode)
  ...
  return (
    <button
      ...
      className="relative inline-flex h-10 w-20 items-center rounded-full bg-gray-200 dark:bg-gray-700 transition-colors duration-300"
